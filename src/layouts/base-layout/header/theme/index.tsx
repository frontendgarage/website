    ...
    <Listbox value={theme} onChange={setTheme}>
      ...
      <Listbox.Options
        className={classNames(
          'absolute z-50 top-10 right-20 bg-white rounded-lg ring-1 ring-slate-900/10 shadow-lg overflow-hidden w-36 py-1 text-sm text-slate-700 font-semibold dark:bg-slate-800 dark:ring-0 dark:highlight-white/5 dark:text-slate-300',
          panelClassName,
        )}
      >
